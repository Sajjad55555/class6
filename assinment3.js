...
function splicers(anIndex, addRmove, addValue) {
    let arry = ["heloo", "world"];
...
var shopingcart = ["sugar", "cocke"];
function additem(index, addRmove, addValue) {
    shopingcart.splice(index, addRmove, addValue);
    console.log(shopingcart);
}
function remove(index, addRmove) {
